...
if (posY1-lastY1 > 20 && posY1-lastY1 < 100 && (posX1-lastX1 > -10 || posX1-lastX1 < 10 ) ){printf ("Player%i: Abajo\n", player);
caso=-1;
}

if (posY1-lastY1<-20 && posY1-lastY1>-100 && (posX1-lastX1 > -10 || posX1-lastX1 < 10 )){printf ("Player%i: Arriba\n", player);
caso=1;
}

if (posX1-lastX1<-50 && posX1-lastX1>-100 && (posY1-lastY1 > -10 || posY1-lastY1 < 10)){printf ("Player%i: Derecha\n", player);
caso=2;
}

if (posX1-lastX1>50 && posX1-lastX1<100 && (posY1-lastY1 > -10 || posY1-lastY1 < 10)){printf ("Player%i: Izquierda\n", player);
caso=-2;
}

if (posY1-lastY1 > 20 && posY1-lastY1 < 100 && posX1-lastX1 > 10){printf("Player%i: Diagonal Izquierda Abajo \n", player);
caso= 3;}
if (posY1-lastY1<-20 && posY1-lastY1>-100 && posX1-lastX1 < -10){printf ("Player%i: Diagonal Derecha Arriba\n", player);
caso= 4;}
if (posX1-lastX1<-50 && posX1-lastX1>-100 && posY1-lastY1 > 10){printf ("Player%i: Diagonal Derecha Abajo\n", player);
caso= 5;}
if (posX1-lastX1>50 && posX1-lastX1<100 && posY1-lastY1 < -10){printf ("Player%i: Diagonal Izquierda Arriba\n", player);
caso= 6;}
...
if (posY2-lastY2 > 20 && posY2-lastY2 < 100 && (posX2-lastX2 > -10 || posX2-lastX2 < 10 ) ){printf ("Player%i: Abajo\n", player);
caso= -1;
}

if (posY2-lastY2<-20 && posY2-lastY2>-100 && (posX2-lastX2 > -10 || posX2-lastX2 < 10 )){printf ("Player%i: Arriba\n", player);
caso= 1;
}

if (posX2-lastX2<-50 && posX2-lastX2>-100 && (posY2-lastY2 > -10 || posY2-lastY2 < 10)){printf ("Player%i: Derecha\n", player);
caso= 2;
}

if (posX2-lastX2>50 && posX2-lastX2<100 && (posY2-lastY2 > -10 || posY2-lastY2 < 10)){printf ("Player%i: Izquierda\n", player);
caso= -2;
}

if (posY2-lastY2 > 20 && posY2-lastY2 < 100 && posX2-lastX2 > 10){printf("Player%i: Diagonal Izquierda Abajo \n", player);
caso= 3;}
if (posY2-lastY2<-20 && posY2-lastY2>-100 && posX2-lastX2 < -10){printf ("Player%i: Diagonal Derecha Arriba\n", player);
caso= 4;}
if (posX2-lastX2<-50 && posX2-lastX2>-100 && posY2-lastY2 > 10){printf ("Player%i: Diagonal Derecha Abajo\n", player);
caso= 5;}
if (posX2-lastX2>50 && posX2-lastX2<100 && posY2-lastY2 < -10){printf ("Player%i: Diagonal Izquierda Arriba\n", player);
caso= 6;}
