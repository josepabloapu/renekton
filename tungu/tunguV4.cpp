...
//This function threshold the HSV image and create a binary image
 ...
 int trackObject(IplImage* imgThresh, int R, int G, int B, int player){
  ...
  case 1:
	...
	if (posY1 < 230 && posY1 > 210){printf ("Player%i: Quieto\n", player); caso=0;}

	///Abajo///

	if (posY1 < 440 && posY1 > 380){printf ("Player%i: Abajo Extreme\n", player);caso=-4;}

	if (posY1 < 380 && posY1 > 320 ){printf ("Player%i: Abajo Rapido\n", player);caso=-3;}

	if (posY1 < 320 && posY1 > 260){printf ("Player%i: Abajo \n", player);caso=-2;}

	if (posY1 < 260 && posY1 > 230 ){printf ("Player%i: Muy Lento \n", player);caso=-6;}


	///Arriba///

	if (posY1 < 60 && posY1 > 0){printf ("Player%i: Arriba Extreme\n", player);caso=4;}
	
	if (posY1 < 120 && posY1 > 60){printf ("Player%i: Arriba  Muy Rapido\n", player);caso=3;}

	if (posY1 < 180 && posY1 > 120){printf ("Player%i: Arriba Rapido\n", player);caso=2;}

	if (posY1 < 210 && posY1 > 180){printf ("Player%i: Arriba\n", player);caso=6;}
  ...
  case 2:
	...
	if (posY2 < 230 && posY2 > 210){printf ("Player%i: Quieto\n", player); caso=0;}

	///Abajo///

	if (posY2 < 440 && posY2 > 380){printf ("Player%i: Abajo Extreme\n", player);caso=-4;}

	if (posY2 < 380 && posY2 > 320 ){printf ("Player%i: Abajo Rapido\n", player);caso=-3;}

	if (posY2 < 320 && posY2 > 260){printf ("Player%i: Abajo \n", player);caso=-2;}

	if (posY2 < 260 && posY2 > 230 ){printf ("Player%i: Muy Lento \n", player);caso=-6;}


	///Arriba///

	if (posY2 < 60 && posY2 > 0){printf ("Player%i: Arriba Extreme\n", player);caso=4;}
	
	if (posY2 < 120 && posY2 > 60){printf ("Player%i: Arriba  Muy Rapido\n", player);caso=3;}

	if (posY2 < 180 && posY2 > 120){printf ("Player%i: Arriba Rapido\n", player);caso=2;}

	if (posY2 < 210 && posY2 > 180){printf ("Player%i: Arriba\n", player);caso=6;}
