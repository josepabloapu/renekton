...
//This function threshold the HSV image and create a binary image
 ...
 int trackObject(IplImage* imgThresh, int R, int G, int B, int player){
  ...
  case 1:
	...
	if (posY1 < 440 && posY1 > 400){printf ("Player%i: Abajo Extreme\n", player);caso=-5;}

	if (posY1 < 400 && posY1 > 360 ){printf ("Player%i: Abajo Muy Rapido\n", player);caso=-4;}

	if (posY1 < 360 && posY1 > 320){printf ("Player%i: Abajo Rapido \n", player);caso=-3;}

	if (posY1 < 320 && posY1 > 280 ){printf ("Player%i: Abajo \n", player);caso=-2;}

	if (posY1 < 280 && posY1 > 240){printf ("Player%i: Abajo Lento \n", player);caso=0;}

	if (posY1 < 240 && posY1 > 210){printf ("Player%i: Abajo Muy Lento\n", player);caso=0;}

	///Arriba///

	if (posY1 < 40 && posY1 > 0){printf ("Player%i: Arriba Extreme\n", player);caso=5;}
	
	if (posY1 < 80 && posY1 > 40){printf ("Player%i: Arriba  Muy Rapido\n", player);caso=4;}

	if (posY1 < 120 && posY1 > 80){printf ("Player%i: Arriba Rapido\n", player);caso=3;}

	if (posY1 < 160 && posY1 > 120){printf ("Player%i: Arriba\n", player);caso=2;}

	if (posY1 < 200 && posY1 > 160){printf ("Player%i: Arriba Lento\n", player);caso=0;}
  ...
  case 2:
	...
	if (posY2 < 440 && posY2 > 400){printf ("Player%i: Abajo Extrem\n", player);caso=-5;}

	if (posY2 < 400 && posY2 > 360){printf ("Player%i: Abajo Muy Rapido\n", player);caso=-4;}

	if (posY2 < 360 && posY2 > 320){printf ("Player%i: Abajo Rapido\n", player);caso=-3;}

	if (posY2 < 320 && posY2 > 280){printf ("Player%i: Abajo \n", player);caso=-2;}

	if (posY2 < 280 && posY2 > 240){printf ("Player%i: Abajo Lento\n", player);caso=0;}

	if (posY2 < 240 && posY2 > 210){printf ("Player%i: Abajo Muy Lento\n", player);caso=0;}

	///Arriba///

	if (posY2 < 40 && posY2 > 0){printf ("Player%i: Arriba Extreme\n", player);caso=5;}
	
	if (posY2 < 80 && posY2 > 40){printf ("Player%i: Arriba Muy Rapido\n", player);caso=4;}

	if (posY2 < 120 && posY2 > 80){printf ("Player%i: Arriba Rapido\n", player);caso=3;}

	if (posY2 < 160 && posY2 > 120){printf ("Player%i: Arriba\n", player);caso=2;}

	if (posY2 < 200 && posY2 > 160){printf ("Player%i: Arriba Lento\n", player);caso=0;}
...
IplImage* imgThresh = GetThresholdedImage(imgHSV, 39, 105, 88, 56, 184, 200);
...
////////////////////GAME PROPERTIES///////////////////////////////////
	...
	pass = checkclave();
      ...
      while(player1Score + player2Score != 5 && pass == true){
