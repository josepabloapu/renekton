...
//This function threshold the HSV image and create a binary image
 ...
 int trackObject(IplImage* imgThresh, int R, int G, int B, int player){
  ...
  case 1:
	...
	if (posY1 < 290 && posY1 > 150){printf ("Player%i: Quieto\n", player); caso=0;}

	///Abajo///

	if (posY1 > 400 && posY1 < 440){printf ("Player%i: Abajo Rapido\n", player);caso=-5;}

	if (posY1 > 360 && posY1 < 400){printf ("Player%i: Abajo Medio\n", player);caso=-4;}

	if (posY1 > 320 && posY1 < 360){printf ("Player%i: Abajo \n", player);caso=-3;}

	if (posY1 > 280 && posY1 < 320){printf ("Player%i: Abajo Medio\n", player);caso=-2;}

	if (posY1 > 240 && posY1 < 280){printf ("Player%i: Abajo \n", player);caso=-1;}

	if (posY1 > 210 && posY1 < 240){printf ("Player%i: Abajo muy lento\n", player);caso=-6;}
	...
	if (posY1 < 230 && posY1 > 200){printf ("Player%i: Arriba muy lento\n", player);caso=6;}
  ...
  case 2:
	...
	if (posY2 < 240 && posY2 > 200){printf ("Player%i: Quieto\n", player);caso=0;}

	///Abajo///

	if (posY2 > 400 && posY2 < 440){printf ("Player%i: Abajo Rapido\n", player);caso=-5;}

	if (posY2 > 360 && posY2 < 400){printf ("Player%i: Abajo Medio\n", player);caso=-4;}

	if (posY2 > 320 && posY2 < 360){printf ("Player%i: Abajo \n", player);caso=-3;}

	if (posY2 > 280 && posY2 < 320){printf ("Player%i: Abajo Medio\n", player);caso=-2;}

	if (posY2 > 240 && posY2 < 280){printf ("Player%i: Abajo \n", player);caso=-1;}

	if (posY2 > 210 && posY2 < 240){printf ("Player%i: Abajo muy lento\n", player);caso=-6;}
	...
	if (posY2 < 230 && posY2 > 200){printf ("Player%i: Arriba muy lento\n", player);caso=6;}
     ...
     cvNamedWindow("Player2");
      ...
      while(true){
		...
		cvSmooth(frame, frame, CV_GAUSSIAN,3,3); //smooth the original image using Gaussian kernel
			...
			IplImage* imgThresh = GetThresholdedImage(imgHSV, 82, 163, 76, 114, 256, 178); //guante cyan
			...
			IplImage* imgThresh2 = GetThresholdedImage(imgHSV2, 39, 113, 57, 57, 226, 188); //guante verde
